...
<head>
    ...
    <title>RK Software Solutions | Best Webiste Design and Development Company | 1st prefrence to you</title>
    ...
    <link type="text/css" rel="stylesheet" href="css/gijgo.css">
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-md-5 ">
                            <div class="header_left">
                                <p>Welcome to RK Software Solutions</p>
                            </div>
                        </div>
                        <div class="col-xl-7 col-md-7">
                            <div class="header_right d-flex">
                                    <div class="short_contact_list">
                                            <ul>
                                                <li><a href="mailto:rkopenmail@gmail.com?subject=RK Software Solutions - Reg.,&body=Hi,I visit your website.I would like to share something that"> <i class="fa fa-envelope"></i> rkopenmail@gmail.com</a></li>
                                                <li><a href="tel:+919600689006"> <i class="fa fa-phone"></i>+91 9600689006</a></li>
                                            </ul>
                                        </div>
                                        <div class="social_media_links">
                                            <a href="https://www.linkedin.com/in/rajkumar-b-a57954bb">
                                                <i class="fa fa-linkedin"></i>
                                            </a>
                                            <a href="https://www.facebook.com/Developerrajkumar">
                                                <i class="fa fa-facebook"></i>
                                            </a>
                                            <a href="https://twitter.com/smilerajkumar">
                            ...
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo" >
                                    <a href="index.html" style="color: white;font-size: 1.25rem;">
                                        <img src="img/favicon/favicon-32x32.png" alt="">RK Software Solutions
                                    </a>
                                </div>
                            </div>
	...
	<?php //echo '[contact-form-7 id="31" title="Contact form 1"]'; 
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p>
                                    <a href="mailto:rkopenmail@gmail.com?subject=RK Software Solutions - Reg.,&body=Hi,I visit your website.I would like to share something that"> <i class="fa fa-envelope"></i> rkopenmail@gmail.com</a> <br>
                                    <a href="tel:+919600689006"> <i class="fa fa-phone"></i> +91 9600689006</a> <br>
                                    Pudhucherry,India.
                            </p>
                            <div class="socail_links">
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/rajkumarrajkumar9406/">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-12">
						...
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="http://rksoftwaresolutions.dx.am" target="_blank">Rajkumar</a>
                        </p>
                    </div>
                </div>
            </div>
